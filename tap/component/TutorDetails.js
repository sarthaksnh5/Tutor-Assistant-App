...
import TimeSelection from '../screens/UserScreen/TimeSelection';
import {appURL} from '../constants/AppConstants';
import RateSelection from '../screens/UserScreen/RateSelection';
import {LogoutBtn} from '../AsyncStorageHelpers/AsyncStorageHelpers';

const TutorDetails = ({email, token, navigation}) => {
  const multipleData = [
    '1',
    '2',
    '3',
